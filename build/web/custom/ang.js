...
var app=angular
               ...
               .state('nav3',{
                 ...
                 controller:['$scope','$http','$stateParams','filterFilter',function($scope,$http,$stateParams,filterFilter){
                var url="showphotu";
               $http.get(url).then(function(data){
                   $scope.prod=data.data;
      $scope.product=filterFilter($scope.prod,{catid:$stateParams.val});
               });
