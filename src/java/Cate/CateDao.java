...
public class CateDao implements CateImp{
    ...
    public String addCate(Cate c) {
        ...
        o.append("cat_id",c.getCatid()).append("cat_name",c.getCatname()).append("cat_date", c.getCatedate());
        ...
        if(c.getCatname().equals(obj.get("cat_name"))|| c.getCatid().equals(obj.get("cat_id")))
        {
            count++;
        }
        }
  ...
  return null;
    ...
    public JSONArray getAllCate() {
     midcate s=new midcate();
        ...
        while (cursor.hasNext()) {
            DBObject obj = cursor.next();
        s.set((String)obj.get("cat_id"),(String) obj.get("cat_name"),(String) obj.get("cat_date"));
